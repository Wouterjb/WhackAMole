...
public class EventManager : MonoBehaviour
{
    ...
    public enum CustomEventType
    {
        ...
        EVENT_SESSION_START = 4,
        EVENT_SESSION_END = 5,
        EVENT_LOADING_STARTED = 5,
        EVENT_LOADING_COMPLETED = 6,
        EVENT_LOADING_PROGRESSED = 7,
        EVENT_UPDATE_HIGHSCORE = 8,
        EVENT_UPDATE_SESSION_TIME = 9,
        EVENT_SCORED_POINTS = 10,
        EVENT_TOTAL_SCORED_POINTS = 11,
    }
